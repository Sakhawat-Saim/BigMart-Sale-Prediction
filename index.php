...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Bigmart Online Groceries Ordering System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient" id="topNavBar">
        <div class="container">
           ...
           Bigmart Online Groceries Ordering System
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <a class="sales" href="http://127.0.0.1:5000">Predict Sales</a>
                    </li>
